...
const CONTENT_POSTS = {
    ...
    "slides": [
      {
        ...
        "bodyHtml": "<p><strong>Chennai · Est. 2020</strong></p><p>Small spaces deserve design.</p>"
      }
    ],
    "postType": "info"
  },
  "who-ssr": {
    ...
    "slides": [
      {
        "type": "html",
        "html": "<div style=\"height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:28px;box-sizing:border-box;text-align:center\"><img src=\"images/team/ssr.jpg\" alt=\"Architect SSR\" style=\"width:180px;height:180px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.35);margin-bottom:18px\"><div class=\"info-slide-heading\">Architect SSR</div><div class=\"info-slide-body\"><p><strong>Founder · SpaceMush Architects</strong></p></div></div>"
      },
      {
        "type": "text",
        "icon": "",
        "heading": "How SSR started SpaceMush",
        "bodyHtml": "<p><strong>Ar. Sivaraman, aka SSR,</strong> is a domain expert in Design &amp; Construction with <strong>18+ years of experience</strong> and <strong>350+ projects</strong>, including work across esteemed firms in India and London.</p><p>SpaceMush is his brainchild — shaped by the idea that the same ambition and quality of design found in large projects should also be possible in small spaces.</p><p>The name itself came from his 7-year-old daughter Saraa, who dreams of designing a cute mushroom house. That idea became the starting point for a practice built around one belief: <strong>Every small space deserves design.</strong></p>"
      }
    ],
    "postType": "info"
  },
  "who-we-are": {
    ...
    "slides": [
      {
        "type": "html",
        "html": "<div style=\"height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;box-sizing:border-box;text-align:center\"><img src=\"images/team/ssr.jpg\" alt=\"Architect SSR\" style=\"width:180px;height:180px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.35);margin-bottom:16px\"><div class=\"info-slide-heading\">Architect SSR</div><div class=\"info-slide-body\"><p><strong>Founder · SpaceMush Architects</strong></p><p>Founder of SpaceMush, bringing 18+ years of experience in design and construction and a practice built around the belief that every small space deserves design.</p></div></div>"
      },
      {
        "type": "html",
        "html": "<div style=\"height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:28px;box-sizing:border-box;text-align:center\"><img src=\"images/team/shyam.jpg\" alt=\"Ar. Shyam Sundar\" style=\"width:180px;height:180px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.35);margin-bottom:18px\"><div class=\"info-slide-heading\">Ar. Shyam Sundar</div><div class=\"info-slide-body\"><p><strong>Principal Architect</strong></p></div></div>"
      },
      {
        "type": "text",
        "icon": "",
        "heading": "Ar. Subash",
        "bodyHtml": "<p><strong>Sr. Architect</strong></p><p>Supports architectural design development, documentation and project coordination.</p>"
      },
      {
        "type": "text",
        "icon": "",
        "heading": "Ar. Archana",
        "bodyHtml": "<p><strong>Jr. Architect</strong></p><p>Supports design development, documentation and project coordination.</p>"
      },
      {
        "type": "text",
        "icon": "",
  ...
  "how-we-design": {
    ...
    "slides": [
      {
        "type": "image",
        "src": "images/posts/la-perle/01.jpg",
        "alt": "La Perle — architecture"
      },
      {
        "type": "image",
        "src": "images/posts/anna-nagar/01.jpg",
        "alt": "Anna Nagar Residence — architecture"
      },
      {
        "type": "text",
        "icon": "📐",
        "heading": "Constraint → Design Decision",
        "bodyHtml": "<p>We start with the site, the people, the light, ventilation, movement and budget — then design around what matters.</p>"
      }
    ],
    "postType": "info"
  },
